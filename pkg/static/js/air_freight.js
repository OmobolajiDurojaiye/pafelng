...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const airwaybillFields = document.getElementById("airwaybillFields");
  ...
  function toggleImportOptions() {
    ...
    if (isImport) {
      ...
      airwaybillFields.classList.add("hidden");
  ...
  function toggleImportFields() {
    const isAirwaybill = document.getElementById("airwaybill").checked;

    if (isAirwaybill) {
      airwaybillFields.classList.remove("hidden");
  ...
  airFreightForm.addEventListener("submit", function (event) {
    let isValid = true;
    ...
    if (document.getElementById("import").checked) {
      if (document.getElementById("airwaybill").checked) {
        requiredFields.push({
          id: "airwaybill_number",
          message: "Please enter an airwaybill number",
        });
      } else {
